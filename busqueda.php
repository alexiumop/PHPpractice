...
<section class="section">
	<div class="col-md-12 align-center">
		<div class="col-md-12 align-center"><h2>Resultado:</h2></div>
		<?php
...
$result = mysqli_query($link, "SELECT * FROM empleados WHERE id = $_POST[id] ");
...
?>
    ...
    <div class='col-md-6'>
            <a href='vistaEmpleados.php' class='button default submit pull-center color-top'>Volver al Listado de Empleados</a>.
    </div>
	</div>
