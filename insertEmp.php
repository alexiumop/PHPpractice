...
$sql = "INSERT INTO empresa (id, nombre) VALUES ('$_POST[id]','$_POST[nombre]')";
if (mysqli_query($conn, $sql)) {
      echo "<p class='align-center'>Creacion exitosa, acceda al siguiente url para insertar empleados:</p>
             <div class='col-md-6'>      
             si el empleado es un programador siga este url: 
            <a href='programador.php' class='button default submit pull-center color-top'>Registrar Programador</a>.
             </div>
             <div class='col-md-6'>
            si el empleado es un diseñador siga el siguiente url:
