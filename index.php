...
<div id="wrapper">
	...
	<section class="section">
	  <form action="insertEmp.php" method="POST">
	  	  <div class="col-md-12">
	  	  	<div class="align-center"><h2>Ingresar Empresa<h2></div>
	  	  		<div class="col-md-4">
               ...
               <div class="col-md-4">
               	<br>
	  	  		<input type="submit" name="enviar" value="Ingresar Empresa" class="button default submit pull-center color-top" onclick=" return validaciones()">
	  	  		</div>
           </div>
