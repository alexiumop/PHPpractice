...
<div id="wrapper">
	...
	<section class="section">
	  <form action="insertProgramador.php" method="POST">

	  	  <div class="col-md-12">
	  	  	<div class="col-md-12 align-center"><h2>Ingresar Empleado:</h2></div>
	  	  	...
	  	  	<div class="col-md-4">
	  	  		Lenguaje en el que se especializa: <select name="leng">
             	<option>PHP</option>
             	<option>JS</option>
	  	  	...
	  	  	<div class="col-md-4">
	  	  		 <input type="hidden" name="programador" value="programador">
	  	  		 <br>
	  	  		 <input type="submit" name="enviar" value="Ingresar Empleado" class="button default submit pull-center color-top" onclick=" return validaciones()"> 	
	  	  	</div>
	  	  </div>
				...
				<div class="row">
					...
					<div class="col-sm-8 col-sm-push-2 col-sm-pull-2">
						...
						<center><div class="inputs-block">
									...
									<p class="input-block">
								<a class="button default submit pull-center color-top" href="mailto:alematute18@gmail.com" id="submit"><i class="icon-paper-plane-2" style="color: #ffffff; font-size: 20px; font-weight: bold;"></i><br><span style="color:#ffffff; font-weight:bold;">Contactame por informacion</span></a>  
								</p>
