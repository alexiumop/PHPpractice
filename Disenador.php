...
<div id="wrapper">
	...
	<section class="section">
	  <form action="insertDis.php" method="POST">
	  	  ...
	  	  <div class="col-md-12">
	  	  	...
	  	  	<div class="col-md-4">
	  	  		Tipo de Diseñador: <select name="dis">
             	<option>Grafico</option>
             	<option>Web</option>
             </select>
	  	  	</div>
	  	  	<div class="col-md-4">
	  	  		<input type="hidden" name="disenador" value="Diseñador">
	  	  		<br>
				...
				<div class="row">
					...
					<div class="col-sm-8 col-sm-push-2 col-sm-pull-2">
						...
						<center><div class="inputs-block">
									...
									<p class="input-block">
								<a class="button default submit pull-center color-top" href="mailto:alematute18@gmail.com" id="submit"><i class="icon-paper-plane-2" style="color: #ffffff; font-size: 20px; font-weight: bold;"></i><br><span style="color:#ffffff; font-weight:bold;">Cualquier Pregunta</span></a>  
								</p>
